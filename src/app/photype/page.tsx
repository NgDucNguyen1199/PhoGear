...
export default async function PhoTypePage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-background text-foreground relative overflow-hidden transition-colors duration-500">
      {/* Background Decor - Adaptive to theme */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute -top-[10%] -left-[5%] w-[70%] h-[70%] bg-primary/10 dark:bg-primary/5 rounded-full blur-[150px] opacity-50 dark:opacity-30" />
        <div className="absolute top-[30%] -right-[5%] w-[60%] h-[60%] bg-blue-500/10 dark:bg-blue-500/5 rounded-full blur-[150px] opacity-30 dark:opacity-20" />
      </div>
      ...
      <main className="flex-grow flex flex-col items-center py-12 relative z-10">
        <div className="text-center mb-16 space-y-4">
          ...
          <h1 className="text-7xl font-black tracking-tight italic uppercase drop-shadow-sm">PHO TYPE</h1>
