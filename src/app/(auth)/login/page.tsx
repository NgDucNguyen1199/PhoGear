      ...
      >
        ...
        <Card className="border-none shadow-2xl rounded-3xl overflow-hidden bg-background/80 backdrop-blur-xl">
          <CardHeader className="space-y-2 pt-8 pb-6 text-center bg-primary/5 border-b border-primary/10">
            <CardTitle className="text-3xl font-black tracking-tight uppercase">Đăng nhập</CardTitle>
            <CardDescription className="text-sm font-medium">
              Chào mừng bạn trở lại với <span className="text-primary font-bold">Pho Gear</span>
            </CardDescription>
          </CardHeader>
              ...
              <div className="grid gap-2">
                <div className="flex items-center justify-between ml-1">
                  ...
                  <Link 
                    ...
                    className="text-[10px] font-bold uppercase tracking-widest text-primary hover:opacity-70"
                  >
                    Quên mật khẩu?
                  </Link>
                </div>
